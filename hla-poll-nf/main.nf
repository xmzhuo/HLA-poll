...
params.polysolver_argument = "bash /home/polysolver/scripts/shell_call_hla_type /home/docker/\$sample.bam Unknown 1 hg38 STDFQ 0 /home/docker/HLA/polysolver/\$sample"
...
params.polysolver_input_bam = "/path/to/*.bam"
params.polysolver_input_bai = "/path/to/*.bai"
...

{
  ...
  'argument': 'bash hla_poll_v1.8.sub.sh !{bam} \$(pwd)',
...
}
{
  ...
  'argument': 'bash /home/polysolver/scripts/shell_call_hla_type /home/docker/\$sample.bam Unknown 1 hg38 STDFQ 0 /home/docker/HLA/polysolver/\$sample',
  'outputDir': './results/hla-poll',
  'sakcpu': '8',
  'sakmem': '16.GB',
  'saktime': '2.hour'
...
workflow {
    ...
    */
    ...
    //* ## step cmd example SAK
    if(params.hla_input_bai) {HLA_bai = Channel.fromPath(params.hla_input_bai).toSortedList()} else {HLA_bai = Channel.fromPath("$baseDir" + "/data/input_sanitychk")}
    ...
    if (params.hla_dockerimg) {
        HLADOC(HLA_bam,HLA_bai,  HLA_ScriptFiles, params.hla_argument, params.hla_dockerimg, params.hla_sakcpu, params.hla_sakmem, params.hla_saktime, params.hla_outputDir)
    } else {
        HLA(HLA_bam,HLA_bai,  HLA_ScriptFiles, params.hla_argument, params.hla_sakcpu, params.hla_sakmem, params.hla_saktime, params.hla_outputDir)   
    }
    //* ## step cmd example SAK
    if(params.polysolver_input_bam) {POLYSOLVER_bam = Channel.fromPath(params.polysolver_input_bam).toSortedList()} else {POLYSOLVER_bam = Channel.fromPath("$baseDir" + "/data/input_sanitychk")}
    //* ## step cmd example SAK
    if(params.polysolver_input_bai) {POLYSOLVER_bai = Channel.fromPath(params.polysolver_input_bai).toSortedList()} else {POLYSOLVER_bai = Channel.fromPath("$baseDir" + "/data/input_sanitychk")}
    ...
    if (params.polysolver_dockerimg) {
        POLYSOLVERDOC(POLYSOLVER_bam,POLYSOLVER_bai,  POLYSOLVER_ScriptFiles, params.polysolver_argument, params.polysolver_dockerimg, params.polysolver_sakcpu, params.polysolver_sakmem, params.polysolver_saktime, params.polysolver_outputDir)
    } else {
        POLYSOLVER(POLYSOLVER_bam,POLYSOLVER_bai,  POLYSOLVER_ScriptFiles, params.polysolver_argument, params.polysolver_sakcpu, params.polysolver_sakmem, params.polysolver_saktime, params.polysolver_outputDir)   
    }
    //* ## step cmd example SAK
